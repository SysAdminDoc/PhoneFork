...
| [UAD-NG v1.2.0](https://github.com/Universal-Debloater-Alliance/universal-android-debloater-next-generation/releases/tag/v1.2.0) | v1.2.0 | 2026-01-12 | **SUPERSEDED 2026-09-05:** upstream renamed its removal vocabulary to Recommended / Advanced / Expert / Unsafe and added a dependency graph; PhoneFork now embeds a pinned snapshot regenerated by `scripts/Update-DebloatDataset.ps1`. Original note: package list still hot-fetched on launch — PhoneFork's debloat lists can stay aligned by hitting their `packages.json` raw URL (no app version coupling). |
| [AppManager v4.0.5](https://github.com/MuntashirAkon/AppManager/releases/tag/v4.0.5) | v4.0.5 | 2025-07-28 | **SUPERSEDED 2026-09-05:** App Manager released v4.1.0 (2026-06-29) and v4.1.1 (2026-09-04). The compat premise was also wrong: its v5 layout is a plaintext `info_v5.am.json` beside an *encrypted* `meta_v5.am.json`, which PhoneFork never wrote. PhoneFork now ships its own `phonefork-backup.v1.json` and claims no interop. |
